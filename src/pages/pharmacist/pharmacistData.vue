    ...
    <div class="bg-white rounded-xl p-6">
      ...
      <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                  <tr v-for="(pharmacist, index) in filteredPharmacist" :key="pharmacist.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <td class="px-3 py-4">
                        <div class="flex gap-1">
                          ...
                          <div @click="deletePharmacist(pharmacist.id)" class="p-1 rounded bg-red-600 cursor-pointer">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
  ...
  methods: {
    deletePharmacist(id){
      let deletePharmacistList = this.pharmacists.filter((e) => e.id != id);
      this.pharmacists = deletePharmacistList;
    }
  },
  computed : {
