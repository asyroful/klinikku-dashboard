    ...
    <div class="bg-white rounded-xl p-6">
      <div class="flex justify-between mb-6">
        ...
        <router-link to="/doctor/add">
          <button type="button" class="text-white bg-primary hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-light rounded-lg text-sm py-2 px-4 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"><span class="pr-2">+</span>Tambah Dokter Baru</button>
        </router-link>
      </div>
      <div>
                  ...
                  <tr v-for="(doctor, index) in filteredDoctor" :key="doctor.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <td class="px-3 py-4">
                        <div class="flex gap-1">
                          ...
                          <div @click="deleteDoctor(doctor.id)" class="p-1 rounded bg-red-600 cursor-pointer">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default {
  ...
  methods: {
    deleteDoctor(id){
      let deleteDoctorList = this.doctors.filter((e) => e.id != id);
      this.doctors = deleteDoctorList;
    }
  },
  computed : {
